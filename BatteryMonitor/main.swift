...
//  BatteryMonitor
//
//  Created by Asim Ahmed on 7/24/17.
...
public struct Battery {
    ...
    public func timeRemaining() -> Int {
        let prop = IORegistryEntryCreateCFProperty(service,
                                                   Key.TimeRemaining.rawValue as CFString, kCFAllocatorDefault, 0)
        return prop!.takeUnretainedValue() as! Int
    }
...
print("\t YOUR APPLE MACBOOK PRO BATTERY TEMPERATURE:     \(battery.temperature())°C")
...
print("\tTIMEREMAINING:       \(battery.timeRemaining())")
